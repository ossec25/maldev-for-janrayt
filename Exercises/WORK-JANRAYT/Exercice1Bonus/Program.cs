...
namespace Loader
{
    ...
    {
        //Comme ceci est mon tout premier exercice : je modifie et m'inspire de la solution existante pour valider le bon fonctionnement
        ...
        {
            // Represente les données binaires brutes stockées en mémoire
            ...
            //allocation de mémoire dans le processus courant
            ...
            //Copie des données vers la mémoire allouée
            Marshal.Copy(sc, 0, payAddr, scSize);

            // Create a thread at the start of the executable shellcode to run it!
            //création d'un thread natif, le point d'entrée correspond à l'adresse mémoire précédemment allouée. Sert à illustrer la création et l'execution d'un thread via l'aPI Win32
            //
            ...
            //Synchro du thread : MEt le thread en attente jusqu'à la fin de l'exectuin du thread créee.
